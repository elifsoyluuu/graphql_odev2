...
const typeDefs = gql`
    ...
    type Mutation {
        ...
        deleteParticcipant(id: ID!): Participant!
...
const resolvers = {
    ...
    Mutation: {
        ...
        updateLocation: (parent, {id, data }) => { 
            const locationIndex = locations.findIndex((location) => location.id === parseInt(id));
            if (locationIndex === -1) {
                throw new Error("Loction not found"); 
            }
